...
export function Slide4() {
    return (
        <div className=' relative w-full bg-auto flex flex-row  md:bg-no-repeat bg-center md:bg-right '>
            ...
            <div className='flex  flex-1 justify-center lg:justify-end items-center h-full sm:min-h-screen px-4 py-16 md:px-24' >
                <div className='text-white flex flex-col md:max-w-lg lg:max-w-3xl px-8 sm:px-8 gap-2 md:gap-6'>
