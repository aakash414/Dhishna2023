                            ...
                            <div className="text-white flex flex-col md:max-w-lg lg:max-w-3xl px-8 sm:px-8 md:gap-6 ani">
                                <div className='flex flex-row '>
                                    <div className='flex flex-col justify-center'>
                                        <p className="text-7xl md:text-[120px] font-bold ani1 text-left font-thunder tracking-wide italic">
                                            CHAKRA
                                        </p>
                                        <p className="text-xl md:text-2xl font-light ani1 leading-6 font-satoshi text-justify md:text-left">
                                            MESAC
                                        </p>
                                    </div>
