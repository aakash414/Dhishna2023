        ...
        <div className=' relative w-full h-full'>
            <div className='flex w-full flex-col'>
                <div className='flex flex-col mx-auto justify-center items-center'>
                    ...
                    <p className='text-white text-7xl sm:text-[120px] text-center font-bold italic pt-2 md:pt-8 font-thunder'>PRO SHOW</p>
                </div>
            ...
            <div className='flex flex-col md:flex-row pt-10'>
                <div className='flex w-full md:w-1/4 h-full justify-center md:justify-end'>
                    <div className='flex items-end jus md:justify-center relative w-full'>
                        ...
                        <Image src={Nikhita} alt="Nikithagandhi" className="absolute w-60 md:w-96 bottom-0 right-0 md:left-20 z-50" width={10000} />
                    </div>
                </div>
