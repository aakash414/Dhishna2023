...
import WorkshopInfo from "@/components/WorkshopInfo";
import imageUrlBuilder from '@sanity/image-url';
import client from '../../../workshop/src/client';
    ...
    return (
        <Fragment>
            <div className="flex w-[300px] h-[300px] group p-2 relative">
                ...
                <img src={urlFor(data.icon).width(300).height(300).url()} className={"object-cover object-center  group-hover:scale-90 transition duration-300 ease-in-out"}></img>
                <p className="text-white ">{data?.details}</p>
                <WorkshopInfo position={2}/>
                <WorkshopInfo position={3}/>
            </div>
